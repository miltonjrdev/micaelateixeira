    ...
    <div id="attendances" className="bg-rose w-full rounded-3xl py-4">
      <div className="container flex flex-col justify-center items-center mx-auto">
        ...
        <div className="flex mx-auto w-24 sm:w-48 h-24 sm:h-36 justify-center space-x-5">
          ...
          <img className="rounded-3xl hover:opacity-95 hover:scale-105 transition-all duration-300" src="/images/att4.png" alt="" />
        </div>
        <div className="mx-auto flex sm:flex-row flex-col items-center w-full sm:w-1/2 py-12 space-x-5 border border-red-500">
